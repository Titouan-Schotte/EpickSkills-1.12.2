...
public class ModelFox extends ModelUtility {
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entity) {
        ...
        if (entity instanceof EntityLivingBase) {
            ...
            float newLimbSwing = limbSwing + ModelUtility.getSwingProgressPrev(living);
        ...
        this.head.rotateAngleX = (float) Math.toRadians(ModelUtility.getHeadPitch((EntityLivingBase) entity)) + 0.6f;
